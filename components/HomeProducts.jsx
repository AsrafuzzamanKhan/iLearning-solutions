  ...
  return (
    <div className="px-6 md:px-16 lg:px-32">
      <div className="flex flex-col items-center pt-14 container mx-auto">
        ...
        <button onClick={() => { router.push('/all-products') }} className="flex justify-center items-center px-12 py-2.5 border rounded text-gray-500/70 hover:bg-slate-50/90 transition cursor-pointer">
          See more
